       ...
       <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <label for="name" class="mb-2 block uppercase text-gray-700 font-bold">Nombre</label>
                ...
                <div class="mb-5">
                    ...
                    <label for="username" class="mb-2 block uppercase text-gray-700 font-bold">Username</label>
                ...
                <div class="mb-5">
                    ...
                    <label for="password_confirmation" class="mb-2 block uppercase text-gray-700 font-bold">Repetir Clave</label>
